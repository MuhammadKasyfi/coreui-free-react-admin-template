...
const AlertSummaryHARTMultiplexer = React.lazy(() => import('./views/dashboard/AlertSummaryHARTMultiplexer'))
const AlertSummaryDeltaV = React.lazy(() => import('./views/dashboard/AlertSummaryDeltaV'))
const AlertSummaryWirelessGateway = React.lazy(() => import('./views/dashboard/AlertSummaryWirelessGateway'))
...
const routes = [
  ...
  { path: '/dashboard/alertSummaryHARTMultiplexer', name: AlertSummaryHARTMultiplexer,  element: AlertSummaryHARTMultiplexer },
  { path: '/dashboard/alertSummaryDeltaV', name: AlertSummaryDeltaV, element: AlertSummaryDeltaV },
  {  path: '/dashboard/alertSummaryWirelessGateway',  name: AlertSummaryWirelessGateway,  element: AlertSummaryWirelessGateway },
